...
import {getAll} from '../../services/CustomeOrders'
...
const Products = () => {
  ...
  let number = 0
    ...
    let tableData = products && products.map(({ id, created_at,name, phone, shop_name, shop_address, question}) => {
        number++
        const data = {
            no: number,
            id: id,
                        ...
                        <CCardBody>
                            <MaterialTable
                                ...
                                columns={[
                                    ...
                                    { title: 'Nama Pengguna', field: 'name' },
                                    { title: 'No. HP', field: 'phone' },
                                    { title: 'Nama Toko', field: 'shop_name' },
                                    { title: 'Alamat Toko', field: 'shop_address' },
                                ]}
                                data={tableData}
