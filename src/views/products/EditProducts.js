...
const EditProducts = (props) => {
    ...
    async function fetchProduct(id) {
        ...
        if(response.status===200){
            ...
            setSubCategory({'id':response.product[0].subcategory_id, 'label':response.product[0].subcategory_name, 'value':response.product[0].subcategory_id})
            fetchSubCategories(response.product[0].subcategory_id,)
        }
    }
                    ...
                    <CFormGroup row>
                            ...
                            <CCol xs="12" md="9">
                                <Select
                                    ...
                                    onChange={(e) => setSubCategory(e.target)}
                                    value={subCategory}
                                />
                            </CCol>
                    </CFormGroup>
