...
import {getByCategory} from '../../services/Subcategories'
       ...
       <CCard>
            ...
            <CCardBody>
                <CForm action="" method="post" className="form-horizontal">
                    ...
                    <CFormGroup row>
                            <CCol md="3">
                                <CLabel htmlFor="name">Sub Kategori</CLabel> &nbsp;
                                <CBadge color="secondary">Wajib</CBadge>
                            </CCol>
                            <CCol xs="12" md="9">
                                <Select
...
Warna : Putih & Hitam" value={description} onChange={(e)=> setDescription(e.target.value)}
                    ...
                    <CFormGroup row>
                        <CCol md="6">
                            <CLabel htmlFor="name">Varian Grup</CLabel>
                        </CCol>
                    </CFormGroup>
                    {
                        VG.map((x, i)=>{
                            ...
                            onChange={e => handleInputChange(e, i)}/>
                                    ...
                                    {/* <CCol xs="2">
                                        <CInputGroup className="input-prepend">
                                            <CInputCheckbox checked={x.is_required===1?true:false} name="is_required" onClick={(e)=>handleInputChange(e, i)} value={x.is_required}/>
                                            <CLabel>Wajib</CLabel>
                                        </CInputGroup>
                                    </CCol> */}
                                    <CCol xs="1" md="1">
                                    ...
                                    x.initAddV.map((y,j)=>{
                                        ...
                                        return(
                                            ...
                                            <CFormGroup row key={i+j}>
                                                ...
                                                {/* <CCol xs="3">
                                                    <CLabel hidden={j===0?false:true}>Harga</CLabel>
                                                    <CInputGroup className="input-prepend">
                                                        <CInput id="appendedPrependedInput" size="12" type="number" placeholder='Harga' value={y.price} name="price" onChange={(e)=>handleInputChange1(e, i,j)} />
                                                    </CInputGroup>
                                                </CCol> */}
                                                <CCol xs="1" md="1">
                                ...
                                <CFormGroup row>
                                    ...
                                    <CCol xs="3">
                                        <CButton hidden={x.initAddV.length===j+1?false:true} color="primary" onClick={(e)=>handleAddClick1(i, j)}>Tambah Varian</CButton>
                                    </CCol>
                                </CFormGroup>
                                </>
                                        )
                    ...
                    <CFormGroup row>
                        ...
                        <CCol xs="3">
                            <CButton color="primary" onClick={handleAddClick}>Tambah Varian Group</CButton>
                        </CCol>
                    </CFormGroup>
                    </>
                    :''
                ...
                <CRow>
                    {
                        ...
                        dis1===true?
                        <CCol xs="12" md="12" align="right">
                            <Link to="/products"><CButton disabled={dis1} onClick={() => console.log("batal")}>Batal</CButton></Link>{' '}
