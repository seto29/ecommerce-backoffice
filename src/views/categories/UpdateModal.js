                    ...
                    <CForm action="" method="post" className="form-horizontal">
                        <CFormGroup row>
                            <CCol xs="12" md="12">
                                ...
                                <CInput type="text" disabled={props.idUpdate==='6'?true:false} placeholder="e.g. : asian, european, etc" value={props.nameUpdate} onChange={(e)=> props.setNameUpdate(e.target.value)} />
                            </CCol>
                        </CFormGroup>
                        <CFormGroup row>
                                <CCol xs="12" md="12">
