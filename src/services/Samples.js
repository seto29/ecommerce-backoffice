...
export const getAll = async () => {
    const response = await axios.get('/samples/GetAll.php')
    console.log(response.data)
    return response.data
};
export const getAllR = async () => {
    const response = await axios.get('/samples/GetAllR.php')
    return response.data
};

export const getAllStockProduct = async () => {
    const response = await axios.get('/samples/GetAllStockProduct.php')
    return response.data
};

export const GetBySupplierID = async (id) => {
    const response = await axios.get('/suppliersamples/GetBySupplierID.php?sID='+id)
    return response.data
};

export const getByID = async (id) => {
  const response = await axios.get('/samples/GetDetailByID.php?id='+id)
  return response.data
};
